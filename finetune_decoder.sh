...
# Training command
accelerate launch examples/wanvideo/model_training/train_decoder.py --config /data2/saikiran.tedla/hdrvideo/diff/diffsynth/configs/finetune_decoder_latentmerge.yaml
